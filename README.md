...
This webpage shows a sneak peek into the project I have developed and deployed, showcasing my skills in HTML CSS, Javascript.
...
```sh
  ...
  git clone https://github.com/Nganjibatexbashi/Barthez_Portfolio.git
```
...
👤 **NGANJI BARTHEZ BASHI**

- GitHub: [nganjibatexbashi](https://github.com/nganjibatexbashi)
- LinkedIn: [nganjibatexbashi]https://nganjibatexbashi.github.io/Barthez_Portfolio/ 
